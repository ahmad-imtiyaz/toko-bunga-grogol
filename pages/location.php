      ...
      <div class="reveal reveal-4 hidden md:block">
        <div class="rounded-3xl p-6 relative overflow-hidden" style="background:rgba(255,255,255,.04); border:1px solid rgba(255,255,255,.1);">
          ...
          <div class="space-y-3 mb-5">
            <div class="flex items-center gap-3 py-2.5 border-b" style="border-color:rgba(255,255,255,.07);"><span class="text-lg flex-shrink-0">📍</span><div><p class="text-[11px] text-white/35 uppercase tracking-wider">Lokasi</p><p class="text-white/80 text-sm font-semibold"><?= e($location['name']) ?>, Grogol</p></div></div>
